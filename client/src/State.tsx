...
const instruments = List([PianoInstrument, DrumInstrument, GuitarInstrument]);
const visualizers = List([WaveformVisualizer, CircleWaveformVisualizer, RaymondVisualizers]);
